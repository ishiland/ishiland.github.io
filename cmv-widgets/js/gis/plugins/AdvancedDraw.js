    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        _drawText: function (result) {
            ...
            var graphic = new Graphic(
                ...
                {
                    OBJECTID: new Date().getTime(),
                    draw_type: 'text',  // eslint-disable-line
                    draw_text_string: 'New Text'  // eslint-disable-line
                },
                null
            );
        ...
        _addGraphicMenu: function (graphic) {
            ...
            editMenu.addChild(new MenuItem({
                label: 'Move',
                onClick: lang.hitch(this, '_editGraphicGeometry', graphic, editor.MOVE)
            }));
            if (type === 'polyline' || type === 'polygon') {
                editMenu.addChild(new MenuItem({
                    label: 'Edit Vertices',
                    onClick: lang.hitch(this, '_editGraphicGeometry', graphic, editor.EDIT_VERTICES)
                }));
                var scaleMenu = new Menu();
                scaleMenu.addChild(new MenuItem({
                    label: 'Uniform Scale',
                    onClick: lang.hitch(this, '_editGraphicGeometry', graphic, editor.SCALE, true)
                }));
                scaleMenu.addChild(new MenuItem({
                    label: 'Freeform Scale',
                    onClick: lang.hitch(this, '_editGraphicGeometry', graphic, editor.SCALE, false)
                }));
                scaleMenu.startup();
                ...
                editMenu.addChild(new MenuItem({
                    label: 'Rotate',
                    onClick: lang.hitch(this, '_editGraphicGeometry', graphic, editor.ROTATE)
                }));
            }
            editMenu.addChild(new MenuItem({
                label: 'Delete',
        ...
        disconnectMapClick: function () {
            topic.publish('mapClickMode/setCurrent', 'advancedDraw');
        },
